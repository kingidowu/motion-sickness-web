          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td>
                ...
                <p style="margin:0;font-family:Arial,sans-serif;font-size:9px;letter-spacing:2px;color:#2a2a2a;text-transform:uppercase;">S55 LLC 路 Houston, TX 路 United States</p>
              </td>
            </tr>
            <tr>
...
export default async function handler(req, res) {
    ...
    <tr>
      <td style="padding:0 0 32px 0;">
        ...
        <p style="margin:0;font-family:Arial,sans-serif;font-size:13px;color:#555;letter-spacing:1px;">
          ${isInstagram ? 'Drop 002 路 Early Access' : 'Drop 002 路 Early Access Confirmed'}
        </p>
      </td>
    </tr>
          ...
          <tr>
            <td style="padding:24px 28px;">
              ...
              <p style="margin:0 0 16px 0;font-family:Arial,sans-serif;font-size:13px;color:#666;line-height:1.85;">
                Drop 002 launches in 2 months. Every piece is limited. There is no restock. You'll get the link before anyone else 鈥?before it hits Instagram.
              </p>
  ...
  try {
    await resend.emails.send({
      ...
      to: email,
      subject: isInstagram
        ? 'Thanks for the support 鈥?your code is coming.'
