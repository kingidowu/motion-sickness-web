...
async function register17track(trackingNumber, carrier) {
  ...
  if (!key) return // optional — tracking link still works without registration
  try {
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;background:#080808;">
      ...
      <tr>
        <td style="padding:0 0 32px 0;">
          ...
          <p style="margin:0;font-family:Arial,sans-serif;font-size:13px;color:#555;letter-spacing:1px;">
            ${product || 'Your Motion Sickness order'} · Shipped via ${carrierLabel}
          </p>
        </td>
      </tr>
      ...
      <tr>
        <td style="padding:32px 0 0 0;border-top:1px solid #1a1a1a;">
          ...
          <p style="margin:0 0 16px 0;font-family:Arial,sans-serif;font-size:9px;letter-spacing:2px;color:#2a2a2a;text-transform:uppercase;">S55 LLC · Houston, TX · United States</p>
