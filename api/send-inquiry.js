          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td style="border-top:3px solid #CC0000;padding-top:24px;">
                ...
                <p style="margin:4px 0 0 0;font-family:Arial,sans-serif;font-size:9px;letter-spacing:3px;color:#444;text-transform:uppercase;">by S55 Â· Houston, TX</p>
              </td>
            </tr>
          </table>
        </td>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr>
              <td>
                ...
                <p style="margin:0;font-family:Arial,sans-serif;font-size:9px;letter-spacing:2px;color:#2a2a2a;text-transform:uppercase;">S55 LLC Â· Houston, TX Â· United States</p>
              </td>
            </tr>
            <tr>
